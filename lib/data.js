...
export const SHELVES = [
  {
    ...
    items: [
      { t: 'Surface Tension', s: 'Physics', ep: 'EP 03 · 5 min', bg: 'linear-gradient(165deg,#173B6B,#38B6C9)' },
      { t: 'The Lever', s: 'Physics', ep: 'EP 09 · 6 min', bg: 'linear-gradient(165deg,#4A2A0E,#C97A3D)' },
      { t: "Newton's Laws", s: 'Physics', ep: 'EP 07 · 6 min', bg: 'linear-gradient(165deg,#3A0F0F,#E05656)' },
      { t: 'Electrolysis', s: 'Chemistry', ep: 'EP 12 · 7 min', bg: 'linear-gradient(165deg,#0E3D44,#38B6C9)' },
      { t: 'Conductors', s: 'Physics', ep: 'EP 05 · 5 min', bg: 'linear-gradient(165deg,#241E63,#7C6CFF)' },
  ...
  },
  {
    ...
    items: [
      { t: 'Basic Algebra', s: 'Maths', ep: 'EP 02 · 5 min', bg: 'linear-gradient(165deg,#153A2C,#3DBB6E)' },
      { t: 'Calculus', s: 'Maths', ep: 'EP 14 · 8 min', bg: 'linear-gradient(165deg,#1A2A50,#4A7CE0)' },
      { t: 'DNA Replication', s: 'Biology', ep: 'EP 06 · 6 min', bg: 'linear-gradient(165deg,#3B1030,#E05691)' },
      { t: 'Photosynthesis', s: 'Biology', ep: 'EP 04 · 5 min', bg: 'linear-gradient(165deg,#123A18,#57C94F)' },
      { t: 'Cellular Biology', s: 'Biology', ep: 'EP 10 · 7 min', bg: 'linear-gradient(165deg,#0E3440,#38B6C9)' },
...
export const FAQS = [
  {
    q: 'Is Learningale aligned with the school curriculum?',
  ...
  },
  {
    ...
    a: 'In our launch market a home lesson teacher typically charges ₦15,000–₦20,000 monthly for one or two subjects. Learningale covers every subject for ₦3,000 a month — or ₦25,000 for the entire year, less than two months of home lessons. The gap is similar in most countries.',
  },
  {
  ...
  {
    q: 'Which countries can use Learningale?',
...
export const PRICING = {
  NGN: { symbol: '₦', monthly: '3,000', yearly: '25,000', save: '31%', permo: '₦2,083/mo' },
  USD: { symbol: '$', monthly: '5', yearly: '40', save: '33%', permo: '$3.33/mo' },
};
